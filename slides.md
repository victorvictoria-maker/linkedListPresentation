...
<div style="display: flex; justify-content: space-around;">
  <img border="rounded" style="width: 40%; " src="/linkedListIllustration.jpg" alt="LinkedListIllustration">
  <img border="rounded" style="width: 55%; " src="/linkedList.png" alt="LinkedList">
</div>
<br>
...
<div style="display: flex; justify-content: space-around; flex-wrap: wrap;">
  ...
  <img border="rounded" style="width: 23%; margin: 1%;" src="/array2.png" alt="Array 2">
  <img border="rounded" style="width: 23%; margin: 1%;" src="/list1.png" alt="List 1">
...
<img border="rounded" style="width: 65%" src="/differentTypesOfLinkedList.webp" alt="DifferentTypesOfLinkedList">
<br>
...
<br>
<img border="rounded" style="width: 65%" src="/unidirectionalLinkedlist.png" alt="UnidirectionalLinkedlist">
...
<br>
<img border="rounded" style="width: 65%" src="/bidirectionalLinkedList.png" alt="BidirectionalLinkedList">
<br>
...
<br>
<img border="rounded" style="width: 65%" src="/circularLinkedList2.png" alt="CircularLinkedList">
<br>
...
<img border="rounded" style="width: 50%; max-height: 90%" src="/linkedListClassJs.png" alt="Class of Linked List ">
...
<img border="rounded" style="width: 100%" src="/thankYou.jpeg" alt="Thank You">
